  ...
  return (
    <div name="work" className='w-full md:h-screen text-gray-300 bg-black '>
        <div className='max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full'>
            ...
            <div 
             className='grid sm:grid-cols-2 md:grid-cols-3 gap-4 mt-8'>
              <div style={{backgroundImage:`url(${Ecommerece})`}} className='shadow-lg shadow[#040c16] group container rounded-md flex justify-center items-center mx-auto content-div'>
